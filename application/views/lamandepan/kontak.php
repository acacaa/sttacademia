				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-3" id="link-effect-3">
						<ul class="nav navbar-nav">
                                                    ...
                                                    <li><?php echo anchor('frontend/kontak','<i class="data-hover"></i> Kontak')?></li>
...
<!-- work-bottom -->
	<div class="team">
            <div class="container">
                <h3 class="w3ls_head" >Jika Ada Pertanyaan, Bisa diajukan disini ya!</h3><br/>
                <br/>
        <?php echo form_open_multipart('frontend/tentang');?>
        <table class="table table-bordered">
            
            <tr>
                <td>Nama Lengkap</td>
                <td>:</td>
                <td><input type="text" class="form-control" required="true" name="nama" id="inputSuccess1"></td>
            </tr>
            <tr>
                <td>Kota</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="kota" id="inputSuccess1" required="true"></td>
            </tr>
            <tr>
                <td>Email</td>
                <td>:</td>
                <td><input type="email" class="form-control" name="email" id="inputSuccess1" required="true"></td>
            </tr>
            <tr>
                <td>Pertanyaan Kamu</td>
                <td>:</td>
                <td><textarea cols="120" rows="18" name="pertanyaan"></textarea></td>
            </tr>
