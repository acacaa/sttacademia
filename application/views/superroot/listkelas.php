...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <?php echo form_open('Admin/kelompokkelas')?>
...
<div class="ch-container">
 ...
 <button id="guru" class="btn btn-primary">Tambah Kelas</button>       
<table id="table_pengajar" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
    ...
    <thead><tr>
        ...
        <th align="center">Aktifkan ( Jika Belum Aktif )</th></tr>
    </thead>
    <?php 
                                $no =1;
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        ...
                                        . "<td>$t->jenjang</td>"
                                        . "<td>$t->status</td>"
                                        . "<td>".anchor('Admin/delete_kelas/'.$t->id,'Hapus Data',array('class'=>'btn btn-round btn-danger'))."</td>"
                                        . "<td>".anchor('Admin/edit_kelas/'.$t->id,'Aktifkan',array('class'=>'btn btn-round btn-success'))."</td>"
                                        . "</tr>";
                                    $no++;
                                }
                          ?>
