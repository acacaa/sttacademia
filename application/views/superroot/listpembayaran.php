    ...
    <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        ...
                                        . "<td>$t->bukti</td>". "<td>$t->status</td>"
                                        . "<td>".anchor('Admin/konfirm_bayar/'.$t->id,'Konfirmasi Pembayaran',array('class'=>'btn btn-round btn-warning'))."</td>"
                                        . "</tr>";
                                    $no++;
                                }
                          ?>
