...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h2>Registrasi Guru Pengajar</h2>
    </div>
    <div class="modal-body">
      <?php echo form_open('Admin/pengajar')?>
        <table class="tbl table-striped">
            <tr>
                <td>Nama Pengajar</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="namapengajar" required></td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
            ...
            <tr>
                <td>Pendidikan (On Going)</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="latarbelakang" required></td>
            </tr>
            <tr>
                <td>Password</td>
                <td>:</td>
    ...
    <div class="modal-body">
        ...
        <table class="tbl table-striped">
            <tr>
                <td>Nama Pengajar</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_namapengajar" readonly></td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_alamat" readonly></td>
            </tr>
            <tr>
                <td>Pendidikan (On Going)</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_latarbelakang" readonly></td>
            </tr>

            <tr>
                <td>Tanggal Lahir</td>
                <td>:</td>
                <td><input class="form-control" type="date" name="detailku_tgl_lahir" readonly></td>
            </tr>
            <tr>
                <td>Nama Ayah</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_namaayah" readonly></td>
            </tr>
            <tr>
                <td>Nomer Handphone</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_nohp" readonly></td>
            </tr>
            <tr>
                <td>Email</td>
                <td>:</td>
                <td><input class="form-control" type="email" name="detailku_email" readonly></td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
                <td>
                    <input class="form-control" type="email" name="detailku_jeniskelamin" readonly>
                </td>
            </tr>
        </table>
     </div>
...
<div class="ch-container">
 ...
 <button id="guru" class="btn btn-primary">Register Pengajar</button>       
<table id="table_pengajar" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
    ...
    <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        . "<td>$no</td>"
                                        . "<td>$t->namapengajar</td>"
                                        . "<td>$t->latarbelakang</td>"
                                        . "<td>$t->nohp</td>"
                                        . "<td>$t->email</td>"
                                        . "<td>".anchor('Admin/delete_pengajar/'.$t->id,'Hapus Data',array('class'=>'btn btn-round btn-danger'))."</td>"
                                        . "<td><button class='btn btn-round btn-success detail-btn' data='".$t->id."'>Detail</button></td>"
                                        . "</tr>";
                                    $no++;
                                }
                          ?>
...
<script type="text/javascript">
    ...
    $('#table_pengajar').on('click', '.detail-btn', function(){
        ...
        $.ajax({
        url: "<?php echo base_url()?>index.php/Admin/detail_pengajar/"+id,
        type: "GET",
        success: function (ajaxData){ 
                var data = JSON.parse(ajaxData);
                //console.log(data[0]['namapengajar']);
                $('input[name="detailku_namapengajar"]').val(data[0]['namapengajar']);
                $('input[name="detailku_alamat"]').val(data[0]['alamat']);
                $('input[name="detailku_latarbelakang"]').val(data[0]['latarbelakang']);
                $('input[name="detailku_tgl_lahir"]').val(data[0]['tgl_lahir']);
                $('input[name="detailku_namaayah"]').val(data[0]['ayah']);
                $('input[name="detailku_nohp"]').val(data[0]['nohp']);
                $('input[name="detailku_email"]').val(data[0]['email']);
                $('input[name="detailku_jeniskelamin"]').val(data[0]['jeniskelamin']);
