    ...
    <div class="modal-body">
        ...
        <table class="tbl table-striped">
            <tr>
                <td>Judul Video</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_waktu" readonly></td>
            </tr>
            <tr>
                <td>Video</td>
                <td>:</td>
            ...
            <tr>
                <td>Mata Pelajaran</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_nama" readonly></td>
            </tr>

            <tr>
                <td>Keterangan</td>
                <td>:</td>
                <td><input class="form-control" type="date" name="detailku_kota" readonly></td>
            </tr>
            <tr>
                <td>Tanggal Upload</td>
                <td>:</td>
                <td><input class="form-control" type="date" name="detailku_pertanyaan" readonly></td>
            </tr>
    ...
    <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        ...
                                        . "<td>$t->waktu</td>"
                                        . "<td>$t->status</td>"
                                        . "<td>".anchor('Admin/edit_kontak/'.$t->id,'Terjawab',array('class'=>'btn btn-round btn-warning'))."</td>"
...
<script type="text/javascript">
    ...
    $('#table_pengajar').on('click', '.detail-btn', function(){
        ...
        $.ajax({
        url: "<?php echo base_url()?>index.php/Admin/detail_kontak/"+id,
        type: "GET",
        success: function (ajaxData){ 
                var data = JSON.parse(ajaxData);
                console.log(data[0]['url']);
                $('input[name="detailku_waktu"]').val(data[0]['waktu']);
                $('#ser').attr('src',data[0]['url']);
                $('input[name="detailku_nama"]').val(data[0]['nama']);
                $('input[name="detailku_kota"]').val(data[0]['teksvideo']);
                $('input[name="detailku_pertanyaan"]').val(data[0]['pertanyaan']);
