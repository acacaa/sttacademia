...
<div id="myDetail" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
<?php echo form_open('Admin/listpertanyaan');?>
        ...
        <table class="tbl table-striped">
            ...
            <tr>
                <td>Jawaban</td>
                <td>:</td>
                <td><textarea cols="50" rows="5" name="detailku_jawaban"></textarea></td>
            </tr>
            <tr>
    ...
    <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        ...
                                        . "<td>$t->tanggal</td>"
                                        . "<td>$t->status</td>"
                                        . "<td>".anchor('Admin/hapus_pertanyaan/'.$t->id,'Hapus',array('class'=>'btn btn-round btn-danger'))."</td>"
