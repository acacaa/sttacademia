      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            <button type="button" class="navbar-toggle pull-left animated flip">
                <span class="sr-only">Lavelindo</span>
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <?php $user = $this->session->userdata('nama'); echo  $user ;?>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a><?php echo anchor('frontend/logout','Log Out')?></a></li>
                </ul>
            </div>
            <!-- user dropdown ends -->
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" ><span><?php echo anchor('frontend/akses','<i class="glyphicon glyphicon-hdd" ></i> List Pembayaran')?></span></a></li >
                    </ul>
...
<div class="ch-container">
    ...
    <div id="content" class="col-lg-10 col-sm-12">
       ...
       <?php echo form_open('frontend/login');?>
        ...
        <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        ...
                                        . "<td>$t->TG_NAMA</td>"
                                        . "<td>$t->KOTA_NAMA</td>"
                                        . "<td>$t->PESAN_JMLORG</td>"
                                        . "<td>$t->PESAN_BIAYA</td>"
                                        . "<td>$t->PESAN_TGL_DTG</td>"
                                        . "<td>$t->PESAN_TGL_PLG</td>"
                                        . "<td>$t->PESAN_REK_NAMA</td>"
                                        . "<td>$t->PESAN_REK_NAMABANK</td>"
                                        . "<td>$t->PESAN_STATUS</td>"    
                                        . "<td>".anchor('frontend/delete_posting/'.$t->PESAN_ID,'PEMBATALAN',array('class'=>'btn btn-round btn-warning'))."</td>"
                                        . "<td>".anchor('frontend/konfirmasi/'.$t->PESAN_ID,'KONFIRMASI BAYAR',array('class'=>'btn btn-round btn-success'))."</td>"
                                        . "</tr>";
                                    $no++;
                                }
                          ?>
