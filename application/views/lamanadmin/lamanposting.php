...
<?php echo form_open('backend/osas');?>
        <button type="submit" class="btn btn-round btn-primary" name="submit">Tambah Postingan</button>
        ...
        <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        . "<td>$no</td>"
                                        . "<td>$t->namabarang</td>"
                                        . "<td>$t->kategoribarang</td>"
                                        . "<td>$t->kabupaten</td>"
                                        . "<td>$t->tgl</td>"
                                        . "<td>".anchor('Backend/delete_posting/'.$t->id,'Hapus Posting',array('class'=>'btn btn-round btn-success'))."</td>"
                                        . "</tr>";
                                    $no++;
                                }
                          ?>
