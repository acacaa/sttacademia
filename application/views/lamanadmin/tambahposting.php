...
<?php echo form_open_multipart('backend/tambahposting')?>
        <table class="table-hover">
            <tr>
                <td>Judul</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="namabarang" id="inputSuccess1"></td>
            </tr>
            <tr>
                <td>Jenis Posting</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="jenisposting"></td>
            </tr>
            <tr>
                <td>Foto Header</td>
                <td>:</td>
            ...
            <tr>
                <td>Deskipsi</td>
                <td>:</td>
                <td><textarea name="deskripsi" id="editor1" cols="8" rows="10"></textarea></td>
            </tr>
            <tr>
                <td>Kategori Posting</td>
                <td>:</td>
                <td><select name="kategoribarang" id="selectError2" data-rel="chosen" class="form-control">
                    <?php
                     foreach ($tag->result() as $t)
                     {
                         echo "<option value=$t->kategori>$t->kategori</option>";
                     }
                    ?>
                    </select></td>
            </tr>
            <tr>
                <td>Nomor Telpon</td>
                <td>:</td>
                <td><input type="number" class="form-control" name="notelpon"></td>
            </tr>
            <tr>
                <td>Kabupaten</td>
                <td>:</td>
            ...
            <tr>
                <td colspan="2">
                    <button type="submit" name="submit" class="button btn-success">Simpan</button>
                </td>
