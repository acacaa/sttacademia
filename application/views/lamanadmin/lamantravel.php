...
<?php echo form_open('backend/listtravel');?>
        <button type="submit" class="btn btn-round btn-primary" name="submit">Posting</button>
    ...
    <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        ...
                                        . "<td>$t->namatravel</td>"
                                        . "<td>$t->berangkat</td>"
                                        . "<td>$t->estimasibiaya</td>"
                                        . "<td>$t->hp</td>"
                                        . "<td>".anchor('Backend/delete_travel/'.$t->id,'Hapus Travel',array('class'=>'btn btn-round btn-success'))."</td>"
                                        . "</tr>";
                                    $no++;
                                }
                          ?>
