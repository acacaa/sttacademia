                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="accordion"><a href="#"><i class="glyphicon glyphicon-eye-open"></i><span> Master Video</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><?php echo anchor('Pengajar/listvideo','List Video')?></li>
                            </ul>
                        </li>
                        <li class="accordion"><a href="#"><i class="glyphicon glyphicon-edit"></i><span> Bank Soal</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><?php echo anchor('Pengajar/kelompoksoal','Kelompok Soal')?></li>
                                <li><?php echo anchor('Pengajar/listsoal','List Soal')?></li>
                            </ul>
                        </li>
                        <li class="accordion"><a href="#" ><i class="glyphicon glyphicon-list-alt"></i><span> Master Kelas</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><?php echo anchor('Pengajar/kelompokkelas','Kelompok Kelas')?></li>
                                <li><?php echo anchor('Pengajar/ruangkelas','Ruang Kelas')?></li>
                            </ul>
                        </li>
                       <li class="accordion"><a href="#" ><i class="glyphicon glyphicon-road"></i><span> Enroll Siswa</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><?php echo anchor('Pengajar/enrollsiswa','Enroll Siswa')?></li>
                            </ul>
                        </li>
                        <li class="accordion"><a href="#" ><i class="glyphicon glyphicon-send"></i><span> Siswa Bertanya</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><?php echo anchor('Pengajar/listpertanyaan','List Pertanyaan')?></li>
                            </ul>
                        </li>
                </div>
            </div>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h2>Tambah Soal Ke Bank Soal</h2>
    </div>
    <div class="modal-body">
      <?php echo form_open_multipart('Admin/listsoal')?>
        <table class="tbl table-striped">
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                <select name="idkelas" id="selectError2" data-rel="chosen" class="form-control">
                <?php foreach ($kelas->result() as $t)
                      {
                        echo "<option value='".$t->id."'>$t->namakelas</option>";
                      }
                    ?>
                </select>
                </td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                <select name="idkelompok" id="selectError2" data-rel="chosen" class="form-control">
                <?php foreach ($kelompoksoal->result() as $t)
                      {
                        echo "<option value='".$t->id."'>$t->jeniskelompok</option>";
                      }
                    ?>
                </select>
                </td>
            ...
            <tr>
                <td>Soal </td>
                <td>:</td>
                <td><textarea name="isisoal" id="isisoal" rows="5" cols="40"></textarea></td>
            </tr>
            <tr>
                <td>Pilihan A</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="pilihan1" required></td>
            </tr>
            <tr>
                <td>Pilihan B</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="pilihan2" required></td>
            </tr>
            <tr>
                <td>Pilihan C</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="pilihan3" required></td>
            </tr>
            <tr>
                <td>Pilihan D</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="pilihan4" required></td>
            </tr>
            <tr>
                <td>Pilihan E</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="pilihan5" required></td>
            </tr>
            <tr>
                <td>Jawaban</td>
                <td>:</td>
                <td><select name="kuncijawaban" required class="form-control">
                                <option value="pilihan1"> A</option>
                                <option value="pilihan2"> B</option>
                                <option value="pilihan3"> C</option>
                                <option value="pilihan4"> D</option>
                                <option value="pilihan5"> E</option>
                    </select ></td>
            </tr>
            <tr>
...
<div class="ch-container">
 ...
 <button id="guru" class="btn btn-primary">Tambah Soal</button>       
