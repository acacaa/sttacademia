...
<div id="myDetail" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      <span class="close">&times;</span>
      <h2>Form Jawab Pertanyaan</h2>
    </div>
    <div class="modal-body">
<?php echo form_open('Pengajar/listpertanyaan');?>
        ...
        <table class="tbl table-striped">
            ...
            <tr>
                <td>Jawaban</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="detailku_jawaban" ></textarea></td>
            </tr>
            <tr>
                <td colspan="3"><button type="submit" name="submit">Jawab</button></td>
            </tr>
    ...
    <?php 
                                ...
                                foreach ($result->result() as $t)
                                {
                                    echo"<tr>"
                                        ...
                                        . "<td>$t->tanggal</td>"
                                        . "<td>$t->status</td>"
                                        . "<td><button class='btn btn-round btn-success detail-btn' data='".$t->id."'>Jawab:</button></td>"
                                        . "</tr>";
                                    $no++;
                                }
                          ?>
