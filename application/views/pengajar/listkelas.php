...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <?php echo form_open('Pengajar/kelompokkelas')?>
        <table class="tbl table-striped">
            <tr>
                <td>Nama Kelas</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="namakelas" required></td>
            </tr>
            <tr>
                <td>Jenjang</td>
                <td>:</td>
                <td><select name="jenjang" id="selectError2" data-rel="chosen" class="form-control">
...
<div class="ch-container">
 ...
 <button id="guru" class="btn btn-primary">Usul Kelas Baru</button>       
