...
<div class="ch-container">
    <h3>Enroll Siswa Ke Kelas</h3>
    <?php echo form_open('pengajar/enrollsiswa');?>
    <div id="content" class="col-lg-10 col-sm-10">
        <table class="table table-bordered">
            <tr>
                ...
                <td>:</td>
                <td>
                    <select name="namasiswa" id="selectError2" data-rel="chosen" class="form-control">
                        <?php
                            foreach ($namasiswa->result() as $r)
                            {
                                echo "<option value='$r->id'>$r->nama_siswa</option>";
                            }
                        ?>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <select name="kelas" id="selectError2" data-rel="chosen" class="form-control">
                        <?php
                            foreach ($kelas->result() as $r)
                            {
                                echo "<option value='$r->id'>$r->namakelas</option>";
                            }
                        ?>
                    </select>
                </td>
            ...
            <tr>
                <td colspan="3"><button type="submit" name="submit"  class="btn-round-success">Enroll</button></td>
            </tr>
        </table>
