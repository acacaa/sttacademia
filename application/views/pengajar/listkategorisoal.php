...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <?php echo form_open('Pengajar/kelompoksoal')?>
        <table class="tbl table-striped">
            <tr>
                <td>Nama Kategori</td>
                <td>:</td>
                <td><input class="form-control" type="text" name="jeniskelompok" required></td>
            </tr>
            <tr>
...
<div class="ch-container">
 ...
 <button id="guru" class="btn btn-primary">Kategori Soal Baru</button>       
